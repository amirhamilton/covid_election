...
To assist with understanding the national distribution of R on those five days, I have created density plots shown below. While very similar, November 4 and October 28 have peaks that are noticeably further to the right, indicating the large R number.
```{r}
...
modelsummary::modelsummary(models = Rt_diff_trump_list, 
                           stars = TRUE, 
                           title = "Regression Table between Percentage of Trump Votes and R")
```
